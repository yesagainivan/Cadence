...
```bash
cd cadence-core && PATH="$HOME/.rustup/toolchains/stable-aarch64-apple-darwin/bin:$PATH" wasm-pack build --target web --features wasm 2>&1 && cp pkg/cadence_core.js pkg/cadence_core_bg.wasm pkg/cadence_core.d.ts ../editor/src/wasm/
```